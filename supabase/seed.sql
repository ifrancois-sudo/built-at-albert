...
begin
  ...
  insert into public.ideas (author_id, title, problem, description, language, tags, status, published_at)
  values
    (seed_author, 'Un planning unifié des trois campus',
     ...
     'fr', array['planning','campus'], 'open', now() - interval '12 days'),
    (seed_author, 'Trouver une salle libre en deux secondes',
     ...
     'fr', array['campus','productivite'], 'open', now() - interval '11 days'),
    (seed_author, 'Une banque d''annales par matière',
     ...
     'fr', array['revisions','equite'], 'open', now() - interval '10 days'),
    (seed_author, 'Le vrai comparateur de stages',
     ...
     'fr', array['stage','carriere'], 'open', now() - interval '9 days'),
    (seed_author, 'Un point unique pour les deadlines',
     ...
     'fr', array['planning','revisions'], 'open', now() - interval '9 days'),
    (seed_author, 'Covoiturage entre campus et gares',
     ...
     'fr', array['transport','entraide'], 'open', now() - interval '8 days'),
    (seed_author, 'Le menu de la cantine, la veille',
     ...
     'fr', array['campus','quotidien'], 'open', now() - interval '8 days'),
    (seed_author, 'Un annuaire des alumni par secteur',
     ...
     'fr', array['carriere','reseau'], 'open', now() - interval '7 days'),
    (seed_author, 'Générateur de plan de révision',
     ...
     'fr', array['revisions','productivite'], 'open', now() - interval '7 days'),
    (seed_author, 'Marché des manuels et du matériel',
     ...
     'fr', array['quotidien','entraide'], 'open', now() - interval '6 days'),
    (seed_author, 'Suivi de candidatures',
     ...
     'fr', array['carriere','stage'], 'open', now() - interval '6 days'),
    (seed_author, 'Un simulateur de moyenne',
     ...
     'fr', array['notes','revisions'], 'open', now() - interval '5 days'),
    (seed_author, 'Formation de groupes de projet',
     ...
     'fr', array['projets','equite'], 'open', now() - interval '5 days'),
    (seed_author, 'Le point sur les associations',
     ...
     'fr', array['vie-etudiante'], 'open', now() - interval '4 days'),
    (seed_author, 'Réservation de créneaux avec les profs',
     ...
     'fr', array['campus','productivite'], 'open', now() - interval '4 days'),
    (seed_author, 'Bibliothèque de datasets pour les projets',
     ...
     'fr', array['data','projets'], 'open', now() - interval '3 days'),
    (seed_author, 'Relecture croisée entre élèves',
     ...
     'fr', array['entraide','revisions'], 'open', now() - interval '3 days'),
    (seed_author, 'Suivi des dépenses de colocation',
     ...
     'fr', array['quotidien','entraide'], 'open', now() - interval '2 days'),
    (seed_author, 'A shared glossary for the data courses',
     ...
     'en', array['data','revisions'], 'open', now() - interval '2 days'),
    (seed_author, 'Anonymous course feedback',
     ...
     'en', array['campus','equite'], 'open', now() - interval '1 day'),
    (seed_author, 'Internship interview prep bank',
     ...
     'en', array['carriere','stage'], 'open', now() - interval '1 day'),
    (seed_author, 'Un tableau des bourses et aides',
     ...
     'fr', array['equite','quotidien'], 'open', now() - interval '16 hours'),
    (seed_author, 'Un mur des projets en cours',
     ...
     'fr', array['projets','reseau'], 'open', now() - interval '10 hours'),
    (seed_author, 'Rappels administratifs de rentrée',
     ...
     'fr', array['quotidien','campus'], 'open', now() - interval '4 hours')
